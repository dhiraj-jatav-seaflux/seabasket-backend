...
import { EmailUserDTO, OTPUserDTO, PasswordDTO, RatingsDTO, SignInUserDTO, SignUpUserDTO } from "./dtos";
...
const routes = (app: Router) => {
  ...
  app.post("/review/:productId",acl,bodyValidator(RatingsDTO),addReview);
